        ...
        <section className="min-h-screen pt-8 pb-8 px-[6vw] bg-ivory paper-grain" ref={containerRef}>
            <div className="max-w-5xl mx-auto space-y-6">
                ...
                <div className="space-y-2 text-center">
                    ...
                    <p className="font-serif text-[15px] text-text-secondary max-w-2xl mx-auto leading-tight">
                ...
                <div className="bg-surface border border-guide rounded-paper p-4 lg:p-6 space-y-3 shadow-sm relative overflow-hidden group">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div className="border border-blue-200 bg-blue-50/50 rounded-paper p-4 relative">
                            <h3 className="font-sans text-[13px] font-bold uppercase tracking-wide text-blue-800 mb-2 flex justify-between">
                                <span>Book Balance (Ledger)</span>
                                <span>(Needs JEs)</span>
                            </h3>
                            <div className="space-y-1 font-mono text-[12px] lg:text-[13px] text-blue-900">
                        ...
                        <div className="border border-slate-200 bg-slate-50/50 rounded-paper p-4 relative">
                            <h3 className="font-sans text-[13px] font-bold uppercase tracking-wide text-slate-800 mb-2 flex justify-between">
                                <span>Bank Balance (Statement)</span>
                                <span>(No JEs needed)</span>
                            </h3>
                            <div className="space-y-1 font-mono text-[12px] lg:text-[13px] text-slate-900">
                    ...
                    <div className="mt-1 border-t border-guide pt-3">
                        <h3 className="font-sans text-[12px] font-bold uppercase tracking-wide text-ink mb-2">Required Book Adjusting Entries (Compound JEs)</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <div className="bg-white p-2 rounded border border-guide font-mono text-[12px] shadow-sm space-y-1">
                                <p className="text-emerald-700 font-sans font-bold mb-1 pb-1 border-b border-guide/50 text-[12px]">To record items INCREASING Cash:</p>
                            ...
                            <div className="bg-white p-2 rounded border border-guide font-mono text-[12px] shadow-sm space-y-1">
                                <p className="text-red-700 font-sans font-bold mb-1 pb-1 border-b border-guide/50 text-[12px]">To record items DECREASING Cash:</p>
                        ...
                        <p className="text-[12px] text-text-secondary mt-2 italic flex items-start gap-1 leading-tight">
                ...
                <div className="bg-surface border border-guide rounded-paper p-4 lg:p-6 space-y-3 shadow-sm relative overflow-hidden group">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="font-sans text-[13px] leading-snug text-text-secondary">
                            Estimating uncollectible accounts using the Allowance Method. Remember: <strong className="text-ink text-[13px] font-mono">Net Realizable Value = A/R - Allowance for Doubtful Accounts</strong>.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div className="border border-rose-200 bg-rose-50/50 rounded-paper p-4">
                            <h3 className="font-sans text-[13px] font-bold uppercase tracking-wide text-rose-800 mb-1">
                                % of Credit Sales Method
                            </h3>
                            <p className="font-serif text-[12px] text-rose-900/70 mb-2">(Income Statement Approach)</p>
                            
                            <div className="bg-white p-2 rounded border border-rose-100 mb-2">
                                <p className="font-mono text-[12px] font-bold text-ink mb-1">Formula:</p>
                                <p className="font-mono flex items-center justify-center py-1 bg-rose-100/50 rounded text-rose-900 border border-rose-200 border-dashed text-[12px]">
                                    Exp = Net Credit Sales × % Uncollectible
                                </p>
                            </div>
                            
                            <ul className="space-y-1 font-sans text-[12px] text-text-secondary leading-tight">
                        ...
                        <div className="border border-amber-200 bg-amber-50/50 rounded-paper p-4">
                            <h3 className="font-sans text-[13px] font-bold uppercase tracking-wide text-amber-800 mb-1">
                                Aging of Receivables Method
                            </h3>
                            <p className="font-serif text-[12px] text-amber-900/70 mb-2">(Balance Sheet Approach)</p>
                            
                            <div className="bg-white p-2 rounded border border-amber-100 mb-2">
                                <p className="font-mono text-[12px] font-bold text-ink mb-1">Formula:</p>
                                <div className="font-mono text-[12px] bg-amber-100/50 p-1.5 rounded text-amber-900 border border-amber-200 border-dashed leading-tight">
                    ...
                    <div className="mt-2 border-t border-guide pt-3">
                        <h3 className="font-sans text-[12px] font-bold uppercase tracking-wide text-ink mb-2">Common A/R Journal Entries</h3>
                        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-2 font-mono text-[12px]">
                            <div className="bg-white p-2 rounded border border-guide shadow-sm space-y-1">
                                <p className="font-sans font-bold text-[11px] uppercase text-text-secondary mb-1 border-b border-guide/50 pb-0.5">1. Credit Sale</p>
                            ...
                            <div className="bg-white p-2 rounded border border-guide shadow-sm space-y-1">
                                <p className="font-sans font-bold text-[11px] uppercase text-text-secondary mb-1 border-b border-guide/50 pb-0.5">2. Bad Debt Expense</p>
                            ...
                            <div className="bg-white p-2 rounded border border-guide shadow-sm space-y-1">
                                <p className="font-sans font-bold text-[11px] uppercase text-text-secondary mb-1 border-b border-guide/50 pb-0.5">3. Write-off Uncollectible</p>
                            ...
                            <div className="bg-white p-2 rounded border border-guide shadow-sm space-y-1">
                                <p className="font-sans font-bold text-[11px] uppercase text-text-secondary mb-1 border-b border-guide/50 pb-0.5">4. Recovery (Two JEs)</p>
                                <div className="flex justify-between"><span>Accounts Receivable</span><span>X</span></div>
                ...
                <div className="bg-surface border border-guide rounded-paper p-4 lg:p-6 space-y-3 shadow-sm relative overflow-hidden group">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="p-2 bg-emerald-50 rounded-paper border border-emerald-200 font-mono text-[12px] text-center font-bold text-emerald-900 mt-1 mb-2">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <h3 className="font-sans text-[12px] font-bold uppercase tracking-wide text-text-secondary mb-2 border-b border-guide pb-1">Tracking Systems</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <div className="p-3 border border-guide rounded-paper bg-surface flex flex-col">
                                    <div className="mb-2">
                                        <strong className="text-ink block mb-0.5 text-[13px]">Perpetual System</strong>
                                        <p className="font-sans text-[12px] text-text-secondary leading-tight">Updates real-time. Every sale requires two JEs: one for Revenue/AR, and one to decrease Inventory and increase COGS. Uses "Inventory" account for purchases.</p>
                                    </div>
                                    <div className="mt-auto bg-white p-2 rounded border border-guide shadow-sm">
                                        <p className="font-mono text-[12px] font-bold text-ink mb-1">Formula (Continuous):</p>
                                        <div className="font-mono text-[12px] p-1.5 rounded bg-surface border border-guide border-dashed text-text-secondary">
                                ...
                                <div className="p-3 border border-guide rounded-paper bg-surface flex flex-col">
                                    <div className="mb-2 space-y-1.5">
                                        <strong className="text-ink block mb-0.5 text-[13px]">Periodic System</strong>
                                        <p className="font-sans text-[12px] text-text-secondary leading-tight">Updates at period end. No COGS recorded at time of sale. Uses "Purchases" temporary account.</p>
                                        <div className="p-1.5 bg-amber-50 border border-amber-200 rounded text-amber-900 text-[12px] leading-tight">
                                            <strong className="text-red-700 block mb-0.5 uppercase tracking-wide text-[11px]">Critical Exam Rule:</strong>
                                            You must calculate <strong>Ending Inventory FIRST</strong>, then deduct it from COGAS to find COGS.
                                        </div>
                                    </div>
                                    <div className="mt-auto bg-white p-2 rounded border border-guide shadow-sm">
                                        <p className="font-mono text-[12px] font-bold text-ink mb-1">Formula (End of Period):</p>
                                        <div className="font-mono text-[12px] p-1.5 rounded bg-surface border border-guide border-dashed text-text-secondary">
                        ...
                        {/* Cost Flow Methods */}
                        <div>
                            <h3 className="font-sans text-[12px] font-bold uppercase tracking-wide text-text-secondary mb-2 border-b border-guide pb-1">Cost Flow Assumptions</h3>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                                {/* FIFO */}
                                <div className="border-t-2 border-t-emerald-500 bg-white border border-guide rounded-paper p-3 shadow-sm">
                                    <h4 className="font-serif font-bold text-[15px] text-ink mb-1">FIFO</h4>
                                    <p className="font-sans text-[11px] text-text-secondary uppercase tracking-widest mb-1.5">First-In, First-Out</p>
                                    <ul className="space-y-1 font-sans text-[12px] text-text-secondary leading-tight">
                                        <li>• Oldest units sold first.</li>
                                        <li>• Ending Inventory = newest costs.</li>
                                        <li>• <strong>Inflation:</strong> Highest Net Income.</li>
                                        <li className="pt-1 mt-1 border-t border-guide italic text-[11px]">Note: Yields IDENTICAL results in both Perpetual and Periodic.</li>
                                    </ul>
                                </div>

                                {/* LIFO */}
                                <div className="border-t-2 border-t-rose-500 bg-white border border-guide rounded-paper p-3 shadow-sm">
                                    <h4 className="font-serif font-bold text-[15px] text-ink mb-1">LIFO</h4>
                                    <p className="font-sans text-[11px] text-text-secondary uppercase tracking-widest mb-1.5">Last-In, First-Out</p>
                                    <ul className="space-y-1 font-sans text-[12px] text-text-secondary leading-tight">
                                        ...
                                        <li className="pt-1 mt-1 border-t border-guide italic text-[11px]">Note: Results DIFFER between Perpetual and Periodic.</li>
                                    </ul>
                                </div>

                                {/* Average */}
                                <div className="border-t-2 border-t-blue-500 bg-white border border-guide rounded-paper p-3 shadow-sm">
                                    <h4 className="font-serif font-bold text-[15px] text-ink mb-1">Average Cost</h4>
                                    <p className="font-sans text-[11px] text-text-secondary uppercase tracking-widest mb-1.5">Smoothed Costs</p>
                                    <ul className="space-y-1 font-sans text-[12px] text-text-secondary leading-tight">
                                        ...
                                        <li className="pt-1 mt-1 border-t border-guide italic text-[11px]">Note: Balances out price volatility.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div className="bg-surface border border-guide rounded-paper p-4 lg:p-6 space-y-3 shadow-sm relative overflow-hidden group">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
                        ...
                        <div className="border border-purple-200 bg-purple-50/50 rounded-paper p-3">
                            <h3 className="font-sans text-[12px] font-bold uppercase tracking-wide text-purple-800 mb-1.5 border-b border-purple-200 pb-1">Straight-Line</h3>
                            <div className="bg-white p-1.5 rounded border border-purple-100 mb-2 text-center">
                                <p className="font-mono text-[12px] text-purple-900">(Cost − Residual) / Useful Life</p>
                            </div>
                            <ul className="space-y-1 font-sans text-[12px] text-text-secondary leading-tight">
                        ...
                        <div className="border border-indigo-200 bg-indigo-50/50 rounded-paper p-3">
                            <h3 className="font-sans text-[12px] font-bold uppercase tracking-wide text-indigo-800 mb-1.5 border-b border-indigo-200 pb-1">Double-Declining (DDB)</h3>
                            <div className="bg-white p-1.5 rounded border border-indigo-100 mb-2 text-center">
                                <p className="font-mono text-[12px] text-indigo-900">(1/Life) × 2 × Beg.Book Value</p>
                            </div>
                            <ul className="space-y-1 font-sans text-[12px] text-text-secondary leading-tight">
                        ...
                        <div className="border border-fuchsia-200 bg-fuchsia-50/50 rounded-paper p-3">
                            <h3 className="font-sans text-[12px] font-bold uppercase tracking-wide text-fuchsia-800 mb-1.5 border-b border-fuchsia-200 pb-1">Units-of-Output</h3>
                            <div className="bg-white p-1.5 rounded border border-fuchsia-100 mb-2 space-y-0.5 text-center font-mono text-[11px]">
                    ...
                    <div className="bg-surface border border-guide p-2.5 rounded-paper shadow-sm">
                         <h3 className="font-sans text-[12px] font-bold uppercase tracking-wide text-ink mb-1">Partial Year Depreciation</h3>
                         <div className="flex flex-col md:flex-row gap-2 font-sans text-[12px] text-text-secondary leading-tight">
                ...
                <div className="bg-surface border border-guide rounded-paper p-4 lg:p-6 space-y-3 shadow-sm relative overflow-hidden group">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="flex flex-col md:flex-row gap-2 font-mono text-[12px] text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div className="border border-emerald-200 bg-emerald-50/50 rounded-paper p-3">
                            <h3 className="font-sans text-[12px] font-bold uppercase tracking-wide text-emerald-800 mb-1.5 border-b border-emerald-200 pb-1">Gain (Cash &gt; Book Value)</h3>
                            <div className="bg-white p-2 rounded border border-emerald-100 shadow-sm font-mono text-[12px] space-y-0.5">
                        ...
                        <div className="border border-red-200 bg-red-50/50 rounded-paper p-3">
                            <h3 className="font-sans text-[12px] font-bold uppercase tracking-wide text-red-800 mb-1.5 border-b border-red-200 pb-1">Loss (Cash &lt; Book Value)</h3>
                            <div className="bg-white p-2 rounded border border-red-100 shadow-sm font-mono text-[12px] space-y-0.5">
                                <div className="flex justify-between"><span>Dr. Cash (received)</span><span>X</span></div>
                                <div className="flex justify-between"><span>Dr. Accum.Depreciation (total)</span><span>X</span></div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 pt-2 border-t border-guide">
                        <div className="lg:col-span-2 space-y-2">
                             <h3 className="font-sans text-[12px] font-bold uppercase tracking-wide text-ink">Special Disposal Cases</h3>
                             <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                <div className="bg-surface border border-guide rounded p-2.5 font-sans text-[12px] leading-tight">
                                    ...
                                    <div className="font-mono bg-white p-1 border border-guide rounded text-[11px]">
                        ...
                        <div>
                             <h3 className="font-sans text-[12px] font-bold uppercase tracking-wide text-ink mb-2">Disposal Checklist</h3>
                             <ul className="space-y-1 font-sans text-[12px] text-text-secondary leading-tight">
                ...
                <div className="bg-amber-50 border-l-4 border-amber-500 p-4 rounded-r-paper shadow-sm">
                    <h3 className="font-serif text-[15px] font-bold text-amber-900 mb-2 flex items-center gap-2">
                        <AlertTriangle className="w-4 h-4" />
                        Key Exam Reminders
                    </h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-1 font-sans text-[12px] text-amber-800 leading-tight">
